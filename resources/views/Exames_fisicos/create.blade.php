...
<div class="row">
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="text" class="form-control @error('pressao_arterial_sistolica') is-invalid @enderror"  value="{{old('pressao_arterial_sistolica')}}" id="pressao_arterial_sistolica" placeholder="pressao_arterial_sistolica principal" name="pressao_arterial_sistolica">
