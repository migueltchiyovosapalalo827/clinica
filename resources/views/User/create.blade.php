...
<div class="row">
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <form action="<?= route('user.store') ?>" method="post" class="form-horizontal">
                        ...
                        <div class="col-sm-7">
                            <select class="form-control select" name="tipo"  data-placeholder="<?= ('boilerplate.permission.fields.plc_name') ?>" style="width: 100%;">
                            <?php foreach ($permissions as $permission) { ?>
                                <option <?= in_array($permission['nome'], ['admin']) ? 'selected' : '' ?> value="<?= $permission['nome'] ?>"><?= $permission['nome'] ?></option>
                            <?php } ?>
                            </select>
                            @error('tipo')
  ...
  <div class="form-group  col-md-6">
    ...
    <input type="text" class="form-control @error('nome') is-invalid @enderror"  value="{{old('tipo_conselho')}}" id="tipo_conselho" placeholder="tipo conselho" name="tipo_conselho">
    @error('tipo_conselho')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-6">
    ...
    <input type="text" class="form-control @error('numero_registro') is-invalid @enderror"  value="{{old('numero_registro')}}" id="numero_registro" placeholder="numero de registro" name="numero_registro">
  ...
  <div class="form-group  col-md-6">
    ...
    <input type="text" class="form-control @error('profissao') is-invalid @enderror"  value="{{old('profissao')}}" id="profissao" placeholder="profissao" name="profissao">
    @error('profissao')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-6">
    ...
    <input type="text" class="form-control @error('especialidade') is-invalid @enderror"  value="{{old('especialidade')}}" id="especialidade" placeholder="especialidade" name="especialidade">
    @error('especialidade')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
