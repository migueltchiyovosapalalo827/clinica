...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> actualizar dados dopaciente </h1>
          </div>
          <div class="col-sm-6">
...
<div class="row">
        ...
        <div class="card card-outline">
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <form action="{{ route('paciente.update', $user['id']) }}" method="post" class="form-horizontal">
                    @method('PUT')
                     @csrf
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="text" class="form-control @error('naturalidade') is-invalid @enderror"  value="{{$dadoscomplementar->naturalidade}}" id="naturalidade" placeholder="naturalidade" name="naturalidade">
    @error('naturalidade')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="text" class="form-control @error('estadocivil') is-invalid @enderror"  value="{{$dadoscomplementar->estadocivil}}" id="estadocivil" placeholder="Estado civil" name="estadocivil">
    @error('estadocivil')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="text" class="form-control @error('escolaridade') is-invalid @enderror"  value="{{$dadoscomplementar->escolaridade}}" id="escolaridade" placeholder="escolaridade" name="escolaridade">
    @error('escolaridade')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="text" class="form-control @error('profissao') is-invalid @enderror"  value="{{$dadoscomplementar->profissao}}" id="profissao" placeholder="Estado civil" name="profissao">
    @error('profissao')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-8">
    ...
    <input type="text" class="form-control @error('nome_f') is-invalid @enderror"  value="{{$dadosFamiliares->nome}}" id="nome_f" placeholder="nome" name="nome_f">
    @error('nome_f')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="text" class="form-control @error('idade') is-invalid @enderror"  value="{{$dadosFamiliares->idade}}" id="idade" placeholder="idade" name="idade">
    @error('idade')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="text" class="form-control @error('parentesco') is-invalid @enderror"  value="{{$dadosFamiliares->parentesco}}" id="parentesco" placeholder="parentesco" name="parentesco">
    @error('parentesco')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="email" class="form-control @error('email_f') is-invalid @enderror"  value="{{$dadosFamiliares->email}}" id="email_f" placeholder="email" name="email_f">
    @error('email_f')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
  ...
  <div class="form-group  col-md-4">
    ...
    <input type="text" class="form-control @error('telefone_f') is-invalid @enderror"  value="{{$dadosFamiliares->telefone}}" id="telefone_f" placeholder="telefone" name="telefone_f">
    @error('telefone_f')
         <div class="invalid-feedback">
          <h6>{{$message}}</h6>
         </div>
