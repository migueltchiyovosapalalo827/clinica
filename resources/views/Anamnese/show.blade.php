        ...
        <div class="card card-outline">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link  active " href="#detalhes" data-toggle="tab">Detalhe da Consulta</a></li>
                </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <dl class="row">
                  ...
                  <dd class="col-sm-8">{{$anamnese->prontuario->paciente->user->dadosPessoais->nome}}</dd>
                  <dt class="col-sm-4">medico</dt>
                  <dd class="col-sm-8">{{$anamnese->consulta->profissional_saude->User->dadosPessoais->nome}}</dd>
                  <dt class="col-sm-4">Queixa principal</dt>
                  <dd class="col-sm-8">{{$anamnese->queixa_principal}}</dd>
                  <dt class="col-sm-4">problemas renais</dt>
                  <dd class="col-sm-8"> {{$anamnese->consulta->problemas_renais}} </dd>
                  <dt class="col-sm-4">problemas resperatorios</dt>
                  <dd class="col-sm-8"> {{$anamnese->problemas_resperatorios}} </dd>
                  <dt class="col-sm-4">reumastismo</dt>
                  <dd class="col-sm-8"> {{$anamnese->reumastismo}} </dd>
                  <dt class="col-sm-4">alergias</dt>
                  <dd class="col-sm-8"> {{$anamnese->alergias}} </dd>
                  <dt class="col-sm-4">problemas grasticos</dt>
                  <dd class="col-sm-8"> {{$anamnese->problemas_grasticos}} </dd>
                  <dt class="col-sm-4">historia</dt>
                  <dd class="col-sm-8"> {{$anamnese->historia}} </dd>
                  <dt class="col-sm-4">Data e hora da realização da consulta</dt>
                  <dd class="col-sm-8"> {{$anamnese->created_at}} </dd>
                </dl>
              </div>
              <!-- /.card-body -->
            </div>
            ...
            <div class="row ">
                ...
                <div class="card " style="width: 18rm;">
                   ...
                   <div class="card-body">
                       ...
                       <p class="card-text"></p>
                       <a href="{{route('anamnese.criar',$anamnese->id)}}" class="btn btn-primary">selecionar</a>
                   </div>
                </div>
                </div>
                <div class="col-sm-4">
